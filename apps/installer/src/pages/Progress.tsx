...
export function ProgressPage({ progress, error, canConfirmProgress, onConfirmProgress, onRetry, onBackToOptions }: ProgressProps) {
    ...
    <div className="page-shell">
      <div className="page-scroll">
        <div className="page-container page-container--center" style={{ maxWidth: 420, alignItems: 'center', textAlign: 'center' }}>
          {!error ? (
            <>
              <p style={{ fontSize: 16, fontWeight: 600, color: 'var(--color-text-primary)', marginBottom: 6 }}>{t('progress.title')}</p>
              <p style={{ fontSize: 12, color: 'var(--color-text-muted)', marginBottom: 22 }}>{stepLabel}</p>
      ...
      {!error ? (
        canConfirmProgress && (
          <div className="page-footer page-footer--center">
            <button type="button" className="btn btn-primary" onClick={onConfirmProgress} style={{ justifyContent: 'center' }}>
