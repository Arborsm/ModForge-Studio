...
function App() {
  ...
  const renderPage = () => {
    switch (installer.step) {
      ...
      case 'finish':
        return <Finish installPath={installer.options.installPath} onLaunch={installer.launchApp} onClose={installer.closeInstaller} />
      case 'uninstall':
        return (
          <UninstallPage
  ...
  return (
    <div className="installer-app">
      ...
      <div className="installer-content">{renderPage()}</div>
    </div>
  )
}
