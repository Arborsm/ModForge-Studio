...
const SHORTCUT_NAME: &str = "ModForge Studio.lnk";

/// Create a desktop shortcut for ModForge Studio.
...
/// Create a Start Menu shortcut for ModForge Studio (flat under Programs, no subfolder).
