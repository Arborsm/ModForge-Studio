...
void test('renderHostCommands emits a stable as-const table with camelCase keys', () => {
  ...
  assert.match(rendered, /^\/\/ Generated by apps\/desktop\/scripts\/gen\/generate-host-commands\.mjs\. Do not edit by hand\./)
...
void test('renderRustHandlerBlock groups full paths by module with the generated header', () => {
  ...
  assert.equal(lines[0], '            // Generated by apps/desktop/scripts/gen/generate-host-commands.mjs. Do not edit by hand.')
