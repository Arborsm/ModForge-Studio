...
function printHelp() {
  console.log(`Usage:
  node ./scripts/verify/probe-launcher-cover-api-concurrency.mjs --discover
  node ./scripts/verify/probe-launcher-cover-api-concurrency.mjs --url https://staticdelivery.nexusmods.com/.../cover.jpg
  node ./scripts/verify/probe-launcher-cover-api-concurrency.mjs --urls-file ./cover-urls.txt
