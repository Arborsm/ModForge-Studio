...
function usage() {
  console.log(`Usage: node ./scripts/verify/benchmark-localization-search.mjs [options]
...
Examples:
  node ./scripts/verify/benchmark-localization-search.mjs
  node ./scripts/verify/benchmark-localization-search.mjs --iterations 30 --query "Active on Main Menu"
`)
}
