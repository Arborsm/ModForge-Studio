...
pub fn load_xact_audio_data_url(root_path: String, cue: String) -> Result<String, String> {
    modforge_studio_desktop_lib::logging::log_tauri_command_error("load_xact_audio_data_url", (|| {
        ...
        .map_err(|error| {
            format!("Cue {cue_name} did not resolve to a playable wave entry: {error}")
        })?;
