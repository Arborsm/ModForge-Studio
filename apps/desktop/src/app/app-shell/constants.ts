import type { ThemePreset } from '@app/app-shell/types'
...
export const THEME_STORAGE_KEY = 'modforge:theme:v1'
 ...
 * defined as CSS in `styles/tokens.css` under `[data-theme="<id>"]`. The `accent`
