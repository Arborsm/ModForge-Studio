...
import { getWorldAtlasNameAliases, type WorldMapLayout, type WorldMapLayoutArea } from './worldMapLayout'
export { getWorldAtlasNameAliases, parseWorldMapLayout, type WorldMapLayout, type WorldMapLayoutArea } from './worldMapLayout'
