...
const SKIN_ITEM_SCHEMA: readonly AssetFieldSchema[] = [
  ...
  { key: 'Name', group: 'skins', control: 'localized_text', textCategory: 'locations', labelKey: 'building.skinName' },
  {
    key: 'NameForGeneralType',
    group: 'skins',
    control: 'localized_text',
    textCategory: 'locations',
    labelKey: 'building.skinNameForGeneralType',
  },
  {
    key: 'Description',
    group: 'skins',
    control: 'localized_text',
    textCategory: 'locations',
    labelKey: 'building.skinDescription',
    wide: true,
  },
...
const FIELDS: readonly AssetFieldSchema[] = [
  ...
  },
  {
    ...
    control: 'localized_text',
    textCategory: 'locations',
    labelKey: 'building.nameForGeneralType',
  },
  {
    key: 'Description',
    group: 'basics',
...
export const BUILDING_DATA_SCHEMA: AssetSchema = {
  ...
  groups: [
    ...
    { id: 'texture', labelKey: 'building.texture' },
    { id: 'construction', labelKey: 'building.construction' },
    { id: 'placement', labelKey: 'building.placement', collapsedByDefault: true },
