/**
 * @file Case handler part 6 for vanilla `specificTemporarySprite` sprite ids.
 */
...
/** Resolves specific sprite ids handled in part 6 (remaining vanilla special-cased sprites). */
