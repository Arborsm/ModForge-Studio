/**
 * @file Case handler part 4 for vanilla `specificTemporarySprite` sprite ids.
 */
...
/** Resolves specific sprite ids handled in part 4 (e.g. leahPaintingSetup, farmer hold painting). */
