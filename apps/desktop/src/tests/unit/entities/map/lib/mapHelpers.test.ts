...
import { normalizeMapName } from '@entities/map/lib/mapNames'
import { asMapPropertyString } from '@entities/map/lib/properties'
import { getActionTargetMap, getPortalTargetMapFromProperties, parsePortalTargetMapFromAction } from '@entities/map/lib/portalTargets'
import {
  extractTileFlags,
