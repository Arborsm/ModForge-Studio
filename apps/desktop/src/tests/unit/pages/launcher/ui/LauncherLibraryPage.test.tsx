...
import { LauncherLibraryPage } from '@pages/launcher/ui/LauncherLibraryPage'
...
describe('LauncherLibraryPage', () => {
  ...
  it('keeps mod cards full size inside expanded virtual folders', async () => {
    ...
    expect(folderGrid?.style.gridTemplateColumns).toContain('16.25rem')
    expect(folderGrid?.style.gridAutoRows).toContain('16.25rem')
  })
