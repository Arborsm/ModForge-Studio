...
vi.mock('@pages/launcher/ui/LauncherLibraryPage', () => ({
...
vi.mock('@pages/launcher/ui/LauncherDiscoverPage', () => ({
...
vi.mock('@pages/launcher/ui/LauncherUpdatesPage', () => ({
  LauncherUpdatesPage: () => <div>updates-page</div>,
}))

vi.mock('@pages/launcher/ui/LauncherConfigurationPage', () => ({
