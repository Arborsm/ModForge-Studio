...
import {
  ...
  shortenLibraryPath,
  sortLibraryMods,
} from '@pages/launcher/library/model/launcherLibraryDisplay'
...
function mod(overrides: Partial<LauncherLibraryItem>): LauncherLibraryItem {
  return {
    ...
    minimumApiVersion: overrides.minimumApiVersion ?? null,
    requiresNewerSmapi: overrides.requiresNewerSmapi ?? false,
    ...overrides,
  }
}
