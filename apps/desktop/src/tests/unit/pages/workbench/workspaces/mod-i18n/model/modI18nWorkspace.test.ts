...
import { buildModI18nEntries, extractI18nTokens, updateI18nFileEntry } from '@pages/workbench/workspaces/mod-i18n/model/modI18nWorkspace'
...
describe('mod i18n workspace model', () => {
  ...
  it('filters by text and status', () => {
    const rows = buildModI18nEntries({
      sourceFile: {
        locale: 'default',
        path: 'E:\\Mods\\Example\\i18n\\default.json',
        relativePath: 'i18n/default.json',
