...
import { ContentPatcherResultPreview } from '@pages/workbench/workspaces/mod/mods/content-patcher/content-view/ContentPatcherResultPreview'
...
vi.mock('@pages/workbench/workspaces/mod/mods/content-patcher/content-model/imageCompare', () => ({
