...
const shared: LauncherSharedCopy = {
  ...
  logAnalysis: {
    ...
    setupTitle: 'Set up AI analysis',
    setupDescription:
      'Pick a provider and paste an API key. The key is stored only on this device and is used solely to analyze game-log errors.',
    providerLabel: 'Provider',
    modelLabel: 'Model',
    apiKeyLabel: 'API key',
    apiKeyHint: 'Stored locally on this device in plain text.',
    saveConfigAction: 'Save and analyze',
    runningLabel: 'Analyzing the log…',
    resultTitle: 'AI analysis',
    failedTitle: 'Analysis failed',
    retryAction: 'Retry',
    incompleteConfigMessage: 'Choose a provider and fill in the model and API key.',
  },
  states: {
