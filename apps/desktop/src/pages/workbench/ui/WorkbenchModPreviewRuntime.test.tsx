...
vi.mock('../workspaces/mod', async () => {
  const actual = await vi.importActual<typeof import('../workspaces/mod')>('../workspaces/mod')
  return {
    ...actual,
...
vi.mock('../model/workspace-panels/buildWorkspacePanels', () => ({
