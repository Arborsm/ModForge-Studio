      ...
      {isConstructible ? (
        <>
          <div className="panel-section p-3">
            ...
            <p className="mt-1 text-sm text-[var(--text-primary)]">{props.building.builder ?? props.copy.noneLabel}</p>
          </div>
          <div className="panel-section p-3">
            <p className="panel-section-title">{props.copy.humanDoorLabel}</p>
            <p className="mt-1 text-sm text-[var(--text-primary)]">{formatPoint(props.building.humanDoor, props.copy.noneLabel)}</p>
          </div>
          <div className="panel-section p-3">
            <p className="panel-section-title">{props.copy.animalDoorLabel}</p>
            <p className="mt-1 text-sm text-[var(--text-primary)]">{formatRect(props.building.animalDoor, props.copy.noneLabel)}</p>
          </div>
          <div className="panel-section p-3">
            <p className="panel-section-title">{props.copy.occupantsLabel}</p>
            <p className="mt-1 text-sm text-[var(--text-primary)]">{props.building.maxOccupants}</p>
          </div>
        </>
      ) : (
        <>
          <div className="panel-section p-3">
            ...
            <p className="mt-1 truncate text-sm text-[var(--text-primary)]">{props.building.exteriorMapName ?? props.copy.noneLabel}</p>
          </div>
          <div className="panel-section p-3">
            <p className="panel-section-title">{props.copy.exteriorEntryLabel}</p>
            <p className="mt-1 text-sm text-[var(--text-primary)]">{formatPoint(props.building.exteriorEntryTile, props.copy.noneLabel)}</p>
          </div>
          <div className="panel-section p-3">
          ...
          <div className="panel-section p-3">
            ...
            <p className="mt-1 text-sm text-[var(--text-primary)]">{props.building.worldEntrances.length}</p>
          </div>
        </>
      )}
    </div>
