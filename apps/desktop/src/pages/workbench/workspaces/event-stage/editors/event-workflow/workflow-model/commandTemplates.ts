...
export const COMMAND_TEMPLATES: Record<string, string> = {
  ...
  quickQuestion: 'quickQuestion "Quick choice?#Yes#No(break)message Yes branch.(break)message No branch."',
  ...
  addItem: 'addItem "(O)24" 1',
  removeItem: 'removeItem "(O)24"',
  money: 'money 100',
  friendship: 'friendship Abigail 250',
  animate: 'animate Abigail true true 100 0 1 2 3',
  stopAnimation: 'stopAnimation Abigail 0',
  ...
  addObject: 'addObject 10 15 "(O)372"',
  ...
  farmerEat: 'farmerEat "(O)194"',
  itemAboveHead: 'itemAboveHead "(O)372"',
  mail: 'mail "LetterId"',
